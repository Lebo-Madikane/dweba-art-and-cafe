        ...
        <div className={Style['container']}>
            <div className={Style['row-one']}>
                ...
                <div className={Style['row-one-col-one']}>
                    <Image src='/assets/about-section/About-us-one.webp' alt="About us image" width={150} height={50} placeholder="empty" priority />
                </div>
                <div className={Style['row-one-col-two']}>
                    <Image src='/assets/about-section/About-us-two.webp' alt="About us image" width={150} height={50} placeholder="empty" priority />
                </div>
            </div>
            <div className={Style['row-two']}>
                <div className={Style['row-two-col-one']}>
                    ...
                    <Image className={Style['couch-img']} src='/assets/about-section/About-Couch.webp' alt="logo" width={150} height={50} placeholder="empty" priority />
                </div>
                <div className={Style['row-two-col-two']}>
                    <div className={Style['row-two-col-two-row-one']}>
                        ...
                        <Image className={Style['street-sign-img2']} src='/assets/about-section/About-street-sign.webp' alt="Street sign image" width={150} height={50} placeholder="empty" priority />
                    </div>
