...
const GalleryGrid = () => {
    ...
    const storeroomArtworks = [
        ...
        { src: '/assets/artworks/Storeroom/ART12.webp', alt: 'The Storeroom Artwork', artist: 'Mario Macilau', title: 'Untitled (Faith Series)', medium: 'Digital Print..', size: '120 X 80 cm', year: '2022', price: '$7600 ex VAT' },
