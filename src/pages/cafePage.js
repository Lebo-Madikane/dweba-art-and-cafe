...
const MenuItems = () => (
    <>
        <Head>
            <title>Cafe - Dweba Art & Cafe | Dweba Cafe</title>
            <meta name="description" content="Immerse yourself in a harmonious blend of rich coffee flavours and captivating local artistry." />
        </Head>
